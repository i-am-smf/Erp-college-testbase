...
lb=Label(a,text="M. PREMSRIDEV",font=("Arial",12,"bold")).place(x=1050,y=20)
...
lb=Label(a,text="M. PREMSRIDEV",font=("Arial",14,"bold"),fg="#007FFF").place(x=30,y=260)
...
lb=Label(a,text="7339616512",font=("Arial",10,"bold"),fg="blue").place(x=60,y=330)

lb=Label(a,text="                   Father Name :        K. Meenakshi sundaram                             ",font=("Arial",10),bg="#dff0d8").place(x=0,y=380)
lb=Label(a,text="                  Mother Name :        Saritha .M                                  ",font=("Arial",10),bg="#dff0d8").place(x=0,y=405)
lb=Label(a,text="                            D.O.B :        11/08/2002                                         ",font=("Arial",10),bg="#fcf8e3").place(x=0,y=430)
lb=Label(a,text="                          College :        M.I.E.T. Engg College            ",font=("Arial",10),bg="#fcf8e3").place(x=0,y=455)
...
lb=Label(a,text="                        Enroll No :        E1205071                                    ",font=("Arial",10),bg="#fcf8e3").place(x=0,y=685)
